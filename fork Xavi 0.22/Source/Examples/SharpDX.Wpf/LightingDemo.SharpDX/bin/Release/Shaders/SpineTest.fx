...
//--------------------------------------------------------------------------------------
// File: SpineTest for the Diplomarbeit
// Author: Xavier Albillos / Przemyslaw Musialski
// Date: 06/11/13
// References & Sources: 
...
technique11 RenderSpineTest
{
    ...
    {	
        ...
        SetPixelShader		( CompileShader( ps_4_0, PSDrawTool() ) );
    }    
}