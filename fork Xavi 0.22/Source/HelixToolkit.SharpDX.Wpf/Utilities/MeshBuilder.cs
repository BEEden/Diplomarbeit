namespace HelixToolkit.SharpDX.Wpf
{
    ...
    public class MeshBuilder
    {
        ...
        /// </remarks>
        public void AddCylinder(Point3D p1, Point3D p2, double diameter = 1, int thetaDiv = 32, bool cap1 = true, bool cap2 = true)
        {
            Vector3D n = p2 - p1;
            double l = n.Length();
            n.Normalize();
            this.AddCone(p1, n, diameter / 2, diameter / 2, l, cap1, cap2, thetaDiv);
        }
