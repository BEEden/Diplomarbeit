...
namespace HelixToolkit.SharpDX.Wpf
{
    ...
    public class ObjReader : IModelReader
    {
        ...
        /// The model.
        /// </returns>
        public Mesh3DGroup Read(string path, ModelInfo info = default(ModelInfo))
        {
        ...
        /// The model.
        /// </returns>
        public Mesh3DGroup Read(Stream s, ModelInfo info = default(ModelInfo))
        {
        ...
        /// </remarks>
        public Mesh3DGroup ReadZ(string path)
        {
            this.TexturePath = Path.GetDirectoryName(path);
            using (var s = new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
        ...
        /// A Model3D object.
        /// </returns>
        private Mesh3DGroup BuildModel()
        {
