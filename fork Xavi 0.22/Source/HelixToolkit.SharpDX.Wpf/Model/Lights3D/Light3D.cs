namespace HelixToolkit.SharpDX.Wpf
{
    ...
    public abstract class Light3D : Model3D, ILight3D, IDisposable
    {
        ...
        public static class Model
        {
            //PhongPerVertex,
            //BlinnPhongPerVertex,
            public static readonly string RenderPhong = Techniques.RenderPhong;
            public static readonly string RenderBlinnPhong = Techniques.RenderBlinn;
            public static readonly string RenderColors = Techniques.RenderColors;
        }
