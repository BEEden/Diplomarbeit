// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Viewport3DX.Properties.cs" company="Helix 3D Toolkit">
...
{    
    ...
    using Camera = HelixToolkit.SharpDX.Camera;
    ...
    public partial class Viewport3DX
    {
        ...
        public static readonly DependencyProperty RenderTechniqueProperty = DependencyProperty.Register(
            "RenderTechnique", typeof(string), typeof(Viewport3DX), new PropertyMetadata(Techniques.RenderPhong, (s, e) => ((Viewport3DX)s).RenderTechniquePropertyChanged()));
        ...
        {
            get { return (string)this.GetValue(RenderTechniqueProperty); }
